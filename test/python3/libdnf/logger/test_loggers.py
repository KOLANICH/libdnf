...
class LibdnfLoggerCB(libdnf.logger.Logger):
...
class TestLoggers(unittest.TestCase):
    ...
    def test_object_logrouter(self):
        ...
        # ====================
        for i in range(2):
            log_router.write(libdnf.logger.Logger.Level_CRITICAL, "Critical message")
            log_router.write(libdnf.logger.Logger.Level_ERROR, "Error message")
            log_router.write(libdnf.logger.Logger.Level_WARNING, "Warning message")
            log_router.write(libdnf.logger.Logger.Level_NOTICE, "Notice message")
            log_router.write(libdnf.logger.Logger.Level_INFO, "Info message")
            log_router.write(libdnf.logger.Logger.Level_DEBUG, "Debug message")
            log_router.write(libdnf.logger.Logger.Level_TRACE, "Trace message")
        ...
        tmp_logger = LibdnfLoggerCB(stream1)
        ...
        log2_stream = LibdnfLoggerCB(stream2)
        ...
        # ====================
        log_router.write(libdnf.logger.Logger.Level_INFO, "Info additional message")
